...
Blog: [微信文章](https://mp.weixin.qq.com/s/ppxK7dTOUnNk5iXvk9qiRA)
...
| **Training** | [training/README.md](training/README.md) | How the drafts above were trained: SpecForge (speech LLM) and the [yuekaizhang/speculators (tts branch)](https://github.com/yuekaizhang/speculators/tree/tts) fork (TTS), both on target-regenerated (on-policy) labels. |
